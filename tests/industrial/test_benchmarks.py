    ...
    async def benchmark_async(
        ...
        **kwargs
        ...
        if result.memory_delta_mb > sla.max_memory_growth_mb:
            violations.append(f"Memory growth {result.memory_delta_mb:.2f}MB > {sla.max_memory_growth_mb}MB")
...
class TestCoreBenchmarks:
    ...
    def benchmarker(self):
        return Benchmarker(BenchmarkConfig(
            warmup_iterations=5,
...
def run_all_benchmarks():
    ...
    benchmarker = Benchmarker(BenchmarkConfig(
